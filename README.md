[index.html](https://github.com/user-attachments/files/22412383/index.html)
<!doctype html>
<html lang="de">
<head>
  <meta charset="utf-8" />
...
<body>
  ...
  <main class="container">
    ...
    <section class="hero">
      <div class="card pitch">
        <h1>Elektroinstallationen – schnell, sauber, zuverlässig.</h1>
        <p class="subtitle">Elektroinstallationen, Lampenmontage, Sprechanlagen, Fehlersuche & Reparaturen – alles aus einer Hand in München und Umgebung. <strong>24/7 erreichbar</strong>.</p>
        <div class="badges">
          <span class="chip">⏰ 24/7 erreichbar</span>
          <span class="chip">✅ Kurzfristige Termine</span>
          <span class="chip">🧹 Saubere Ausführung</span>
        </div>
        <p>
          <a class="cta" href="#kontakt">Kostenloses Angebot</a>
          &nbsp;&nbsp;oder&nbsp;&nbsp;
          <a class="whatsapp" href="https://wa.me/4915510149200" target="_blank" rel="noopener">
            <svg viewBox="0 0 32 32" fill="currentColor" aria-hidden="true"><path d="M19.11 17.42c-.27-.13-1.6-.79-1.85-.88-.25-.09-.43-.13-.62.13-.18.27-.71.88-.88 1.06-.16.18-.33.2-.6.07-.27-.13-1.13-.42-2.16-1.34-.8-.71-1.34-1.58-1.5-1.84-.16-.27-.02-.41.11-.54.11-.11.27-.29.4-.44.13-.16.18-.27.27-.45.09-.18.04-.34-.02-.47-.07-.13-.62-1.49-.85-2.05-.23-.55-.46-.47-.62-.47-.16 0-.34-.02-.52-.02-.18 0-.47.07-.71.34-.25.27-.93.91-.93 2.22 0 1.31.95 2.58 1.09 2.76.13.18 1.86 2.84 4.51 3.98.63.27 1.12.43 1.5.55.63.2 1.21.17 1.67.1.51-.08 1.6-.65 1.83-1.28.23-.63.23-1.17.16-1.28-.06-.11-.25-.18-.52-.31z"/></svg>
            WhatsApp
          </a>
        </p>
        <div class="stats">
          <div class="stat"><div>Erreichbarkeit</div><strong>24/7</strong></div>
          <div class="stat"><div>Ø Antwort</div><strong>schnell</strong></div>
          <div class="stat"><div>Einsatzgebiet</div><strong>München</strong></div>
        </div>
      </div>
      <div class="card side">
        <svg viewBox="0 0 400 280" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Elektriker Illustration" style="width:100%;height:100%;display:block;background:linear-gradient(135deg,#0ea5e9, #22c55e);">
  <defs>
  ...
  <!-- Cable -->
  <path d="M20 220 C120 200, 200 260, 380 200" stroke="#0b1229" stroke-width="8" fill="none" opacity=".35"/>
  <!-- Bolt -->
  <polygon points="210,60 170,140 210,140 180,220 250,130 210,130" fill="url(#glow)" stroke="#0b1229" stroke-width="3" opacity=".95"/>
  <!-- Helmet -->
  <ellipse cx="120" cy="120" rx="60" ry="40" fill="#f59e0b" stroke="#111827" stroke-width="3"/>
    ...
    <section id="kontakt">
      ...
      <div class="contact">
        ...
        <div class="card panel">
          ...
          <p>Boschetsrieder Straße 122a<br>81379 München</p>
